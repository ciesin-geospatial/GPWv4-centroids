...
#              where appropriate.
#
# Author:      G. Yetman, CIESIN, Columbia University
#
# Created:     13/11/2015
#-------------------------------------------------------------------------------
import codecs, csv
...
def main():
    """ Opens the centroids file and processes all of the lines to check for length and data type

    No arguments
    """
    # note the use of codecs to handle UTF-8 (Unicode) strings: that is,
    # strings with accents, common in GPW input data
